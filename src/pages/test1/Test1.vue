...
export default {
    ...
    data() {
        return {
            inputAndImgList: [],
            srcList: [
                {id: 1, src: 'https://p1.meituan.net/movie/967b253953bc7e660cfadbf9d78f67b62852693.jpg@160w_220h_1e_1c'},
                {id: 2, src: 'https://p1.meituan.net/moviemachine/f4df6f9c2c55e347266e35027da415251124290.jpg@160w_220h_1e_1c'},
                {id: 3, src: 'https://p0.meituan.net/movie/4bfb08bfe0b8dd20776c6efc4015de6d995158.jpg@160w_220h_1e_1c'},
            ],
            count: 0,
            imgId: 0,
            iptId: 0,
    ...
    methods: {
        ...
        addInputActive() {
            this.iptId++
            this.inputAndImgList.push({ isIpt: true, isImg: false, iptValue: '', iptId: this.iptId });
        },
        addImgActive() {
            // this.count++;
            this.imgId++;
            ...
            this.inputAndImgList.push({ isIpt: false, isImg: true, src: src.src, imgId: this.imgId });
        },
        getData(){
